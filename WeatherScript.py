...
TEMPERATURE_MESSAGES = {
    "freezing": "It's gonna be really cold today: {0} degrees at {1}!!\nThe high today is {2} degrees at {3}.\nMake sure you layer up and wear a good jacket.\n\n",
    "sweaterWeather": "It's gonna get chilly today with a low of: {0} degrees at {1}.\nThe high today is {2} degrees at {3}.\nMake sure you wear a sweater!\n\n",
    "sweaterLayers": "It's gonna get chilly today: {0} degrees at {1}!\nBut it will get hotter to {2} degrees at {3}, so make sure you wear something you can take off when it gets warmer\n\n",
...
PRECIPITATION_MESSAGES = {
    "precipitation": "There is a {0}% chance of {1} today\n",
    "noPrecipitation": "You don't have to worry too much about rain today because there is only a {0}% chance of {1} today.\n"
}
...
def getMessagesForWeather(weatherJson): 
    ...
    weatherInfo = {
        ...
        "averageTempsThroughDay": getAverageTempsThrougDay(hourlyData)
    }
